...
console.log("안녕하세요 (annyeonghaseyo)!\n" + storyData.p_name +",\n\t Welcome to Python Fanfic Story Corner!\nToday, our fanfic has SKZ member, Lee Felix, as our male protagonist, and our female protagonist, " + storyData.p_name);
...
function partI(){
    //let storyData.p_name;
    console.log("Part I of II\n");
    console.log(storyData.p_name+ ": 'I woke up by my alarm, I sat up and yawned. Looking next to me, I saw my cutie pie sleeping. I admired (*stared*) at his adorable face, poking his nose and kissing his forehead I got up and went to the bathroom.\nAfter brushing my teeth, taking a shower, and doing my hair and make-up; I put on my school uniform and went downstairs to make Felix and my breakfast.");
    ...
    console.log(storyData.p_name+": 'Morning my sunshine.' I said, continuing to making breakfast. 'Go and wash up and come back downstairs, okay baby?' He hummed in response, letting go of me and making his way upstairs.\n[20 minutes later] As I was finishing up with setting the table, Felix came downstairs.");
    console.log("\nFelix: 'Thank you for the food babe.' He said pecking my lips as he sat down.\n"+storyData.p_name+": 'You are welcome baby.' I smiled as he gobbled up his food and drank his coffee. I looked at the time it was");
    ...
    console.log(storyData.p_name+": 'No, it is okay, it's only 10 minutes away.' I said pecking his lips one more time and rushing out the door.\nFelix: 'Okay then, bye-bye, love.'\n[10 minutes later] ~ I arrived at school\n\n");
...
function partIII(){
    ...
    console.log(storyData.p_name +"'I've got no other choice, I'll call Felix and hope he won't get mad at me...'\n\n[On the phone]:\n\n"+storyData.p_name+": 'Felix baby..?'\n\nFelix: *breathing heavily* 'Yes baby?...Do you need someone to pick you up? ... I'll pick you up.'\n\n"+storyData.p_name+": 'Yes, b-but I got a f-favor to ask...'\n\nFelix: 'Why are you stuttering, tell me what's wrong baby.'\n\n");
    console.log(storyData.p_name+": 'P-principal told me that I have to call my guardian, but my parents are overseas...and I-I was wondering i-if y-you would come instead......?'\n\nFelix: 'Of course baby, but what is the problem? Did you get hurt?...Did someone bully you...?'\n\n"+storyData.p_name+": 'I-I, she di-...' I burst into tears before I could finish my explanation.\n\nFelix: 'Shhh baby, you are okay...okay? I am coming.' He ended the call.\n\n");
    console.log("Principal: 'Where is your guardian? It has been 20 minutes.'\n" + storyData.p_name + ": 'H-he's coming...'I said as I was rubbing my sore leg in hopes to soothe with the pain.\n"+storyData.p_bully+": 'Her parents are soooo slow,' " + bully + "said annoyed, they are probably like 50 years old.'\n" + storyData.p_bully+"'s Mom: 'Shh, sweetie wait a little longer.'\n");
    console.log(storyData.p_bully + ": 'Ughh-'\n[Knock, Knock, Knock...\nFelix: 'Sorry for the wait.' He said while entering and closing the door behind him.\n\nPrincipal: 'A-aren't you Lee Felix...?' The principal asked looking at the young guy, a little surprised, your group won the award? "+storyData.p_bully+" staring at Felix the whole time...\n\nFelix: 'Yes sir.' He answered.\nPrincipal: 'W-what are you doing here...?'\n\n");
    console.log(storyData.p_bully + ": 'Because I called him duhh, babyyyy-'"+storyData.p_bully+"whined at Felix."+storyData.p_bully+"'s eyes widen...Felix stared at"+storyData.p_bully+"in disgust.\n\nFelix: 'I'm here for my baby, "+storyData.p_name+", "+storyData.p_bully+"'s eyes widen\n\n"+storyData.p_name+": 'Baby,' I said to him grabbing his attention\n\nFelix: 'Hey baby, what's wrong?' He said as he bent down to my level, caressing my cheeks with his hand, the other caressing my hands. Looking into my puffy, yet shiny eyes.");
    console.log("I pointed at my legs, Felix pressed it a little and I whimper.\n\nFelix: 'I am sorry, does it hurt a lot?' He said worriedly. I nodded as a tear rolled down, the principal cleared his throat.\n\nPrincipal: 'L-let's start, "+storyData.p_name+" was seen to have been accused of slapping and pushing "+storyData.p_bully+", but I only saw "+storyData.p_name+" push "+storyData.p_bully+".\n\n"+storyData.p_bully+"'s Mom: 'I say we should suspend "+storyData.p_name+" for doing such a thing to my child!' She blurted out.\n");
    console.log(storyData.p_bully+" smirked, " + storyData.p_bully+":'I don't know why you would date such a person.'\n\n" +storyData.p_name+ ": "+storyData.p_bully+" said in disgust, while looking at me up and down. Felix heard that and was going to do something about it, but I pulled on his sleeve. 'Lixie' I said softly, as I looked at him. He calmed down a little, he kneeled with one knee next to me, eyeing "+storyData.p_bully+".");
    console.log("\nFelix asked 'Do you have any proof? Just because you said it happened...doesn't mean it's true. We can ask other students OR view the security cameras.' Then "+storyData.p_bully+"'s  expression changed.\n\n"+storyData.p_bully+"'s mind: 'Damn it...What if I get suspended?'\n\nFelix: 'Let's view the security footage then.'");
    console.log("While the principal was looking for the footage Felix lifted "+storyData.p_name+" gently and sat himself in the chair previously occupied by his baby. He then placed "+storyData.p_name+" on his lap facing towards him. "+storyData.p_name+" snuggled into his neck, chin resting on Felix's shoulder, and arms wrapped around him. With "+storyData.p_name+" eyes closed, Felix began to stroke "+storyData.p_name+"'s back gently to relax his baby. ");
    console.log("Meanwhile, "+storyData.p_bully+" watched the couple with a zealous expression. The principal finally found the footage during the passing periods in the hallway, where the incident occurred. Everyone in the room except "+storyData.p_name+" watched. After reviewing the footage, They all were shocked as "+storyData.p_bully+" smiled awkwardly, 'hehehe...look, I can explain.\n\nFelix: 'THERE IS NOTHING TO EXPLAIN, LOOK AT THE FOOTAGE!' Felix yelled in anger");
    console.log("\nPrincipal: '"+storyData.p_bully+"! You are suspended'\n"+storyData.p_bully+"'s Mom: 'I am so disappointed! Wait until we get home!'");
    console.log("\n[End of PART III\n");
    var pt = prompt("Would you like to continue reading? 'y' or 'n' to go back to chapters list\n").toLocaleLowerCase()
    if (pt === 'y'){
        partIV();
...
var answer = prompt("Would you like to read 'When you Idol Boyfriend needed to come to your school'? 'r' - OR - Read the synopsis? 's'\n").toLowerCase();
if (answer == 'r'){
    chpt();
}
else if( answer == 's'){
...
//if (startF === True){
    ...
    //os.remove("text_games/Felix/bullstoryData.p_name.wav");}
